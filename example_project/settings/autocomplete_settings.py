...
wgs84_pos = "https://www.w3.org/2003/01/geo/wgs84_pos#"
gnd_geo = "https://www.opengis.net/ont/geosparql#"
stb_find = stb_base + "{}/find"
GenderMappingGND = {
    "male": "https://d-nb.info/standards/vocab/gnd/Gender#male",
    "männlich": "https://d-nb.info/standards/vocab/gnd/Gender#male",
    "Mann": "https://d-nb.info/standards/vocab/gnd/Gender#male",
    "female": "https://d-nb.info/standards/vocab/gnd/Gender#female",
    "weiblich": "https://d-nb.info/standards/vocab/gnd/Gender#female",
    "Frau": "https://d-nb.info/standards/vocab/gnd/Gender#female",
}
...
autocomp_settings = {
    "score": "https://stanbol.apache.org/ontology/entityhub/query#score",
    "uri": "id",
    ...
    "Place": [
        ...
        {
            "source": "GND",
            "type": "https://d-nb.info/standards/elementset/gnd#TerritorialCorporateBodyOrAdministrativeUnit",
    ...
    "Institution": [
        {
            "source": "GND",
            "type": "https://d-nb.info/standards/elementset/gnd#CorporateBody",
        ...
        {
            "source": "GND",
            "type": "https://d-nb.info/standards/elementset/gnd#OrganOfCorporateBody",
            "url": stb_find.format("gndCorporateBodyAndOrganOfCorporateBody"),
            "fields": {
                "descr": (
                    "https://d-nb.info/standards/elementset/gnd#definition",
    ...
    "Person_backup": [
        {
            "source": "GND",
            "type": "https://d-nb.info/standards/elementset/gnd#DifferentiatedPerson",
        ...
        {
            "source": "GND",
            "type": "https://enrich.acdh.oeaw.ac.at/stanbol/entityhub/site/gndRoyalOrMemberOfARoyalHouse/",
    ...
    "Event": [
        {
            "source": "GND",
            "type": "https://d-nb.info/standards/elementset/gnd#HistoricSingleEventOrEra",
...
class StbGeoQuerySettings:
    def __init__(self, kind="place"):
        self.kind = kind
        self.score = "https://stanbol.apache.org/ontology/entityhub/query#score"
        self.uri = "id"
        self.label = "https://www.w3.org/2000/01/rdf-schema#label"
        self.kind = kind
    ...
    def get_data(self, query, adm=None):
        if self.kind == "place" and adm is not None:
            data = {
                "limit": 20,
                "constraints": [
                    {
