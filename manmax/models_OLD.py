...
@reversion.register(follow=["tempentityclass_ptr"])
class ArmourSuit(PhysicalObject):
...
class ArmourPiece(PhysicalObject):
    ...
    TYPES = (
        ("breastplate and backplate", "Breastplate and Backplate"),
        ("tassets", "Tassets"),
        ("helmet", "Helmet"),
        ("right shoulder", "Right Shoulder"),
        ("left shoulder", "Left Shoulder"),
        ("pair of arms", "Pair of Arms"),
        ("pairs of gauntlets", "Pair of Gauntlets"),
        ("pair of leg armour", "Pair of Leg Armour")
    )
    
    piece_type = models.CharField(choices=TYPES, max_length=40)
    
@reversion.register(follow=["tempentityclass_ptr"])
class ArmourCreation(GenericStatement):
    __entity_group__ = ARMOURING
    __entity_type__ = STATEMENT
    
@reversion.register(follow=["tempentityclass_ptr"])
class ArmourAssembly(GenericStatement):
    __entity_group__ = ARMOURING
    __entity_type__ = STATEMENT
...
def construct_properties():
    ...
    armour_creation_armour_piece = build_property("armour piece created", "was created in", ArmourCreation, [ArmourPiece, ArmourSuit])
    armour_creation_created_by_person = build_property("person creating armour", "created armour", ArmourCreation, Person)
    armour_creation_created_in_place = build_property("place created in", "was place of creation of", ArmourCreation, Place)
    armour_creation_factoid = build_property("armour creation is part of factoid", "comprises", ArmourCreation, Factoid)
    
    armour_assembly_pieces = build_property("pieces assembled", "was assembled into suit in", ArmourAssembly, ArmourPiece)
    armour_assembly_suit = build_property("suit assembled", "was assembled in", ArmourAssembly, ArmourSuit)
    armour_assembly_person = build_property("suit assembled by", "assembled armour suit", ArmourAssembly, Person)
    armour_assembly_place = build_property("suit assembled at", "place of suit of armour assembly", ArmourAssembly, Place)
    armour_assembly_factoid = build_property("armour assembly is part of factoid", "comprises", ArmourAssembly, Factoid)
    ...
    birth_event_factoid = build_property("is part of factoid", "factoid comprises", Birth, Factoid)
    ...
    death_event_has_factoid = build_property("is part of factoid", "factoid comprises", Death, Factoid)
    ...
    ownership_of_entity = build_property(
        "thing changing ownership", "changed ownership by", Acquisition, [ArtWork, PhysicalObject]
    )
