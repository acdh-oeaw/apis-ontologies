...
class Instance(TempEntityClass):
    ...
    set_num = models.CharField(max_length=5,
                               choices=SETS,
                               null=True,
                               verbose_name="Set")
    ...
    num_folios = models.CharField(max_length=255,
                                  blank=True,
                                  null=True,
    ...
    signature_number = models.CharField(max_length=255,
                                        blank=True,
                                        null=True,
                                        verbose_name="Signature number")
    drepung_number = models.CharField(max_length=255,
                                      blank=True,
                                      null=True,
    ...
    def citation(self):
        ...
        logger.warn(f"Unknown set: {self.set_num}. Cannot build citation.")
        return f"Unknown set: {self.set_num}. Cannot build citation."
