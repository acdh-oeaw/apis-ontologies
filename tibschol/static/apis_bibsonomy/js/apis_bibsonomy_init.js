function reinitialize_bibsonomy_tooltips() {
	$(".bibsonomy-anker").tooltipster({
		...
		functionInit: function (instance, helper) {
			...
			$res = $('<div class="bibs-container"><table class="table"><thead><tr><td>delete</td><td>id</td><td>authors</td><td>title</td><td>year</td><td>Pages Start</td><td>Pages End</td><td>Folio</td><td>Notes</td><td>Detail</td></tr></thead><tbody></tbody></table></div>')
			$res.append($deepc)
