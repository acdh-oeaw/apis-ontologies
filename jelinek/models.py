...
def construct_properties():
    ...
    data_read_from.subj_class.add(ContentType.objects.get_for_model(model=Honour))
    ...
    was_defined_primarily_in.subj_class.add(ContentType.objects.get_for_model(model=Honour))
    ...
    is_director_of.obj_class.add(ContentType.objects.get_for_model(model=F21_Recording_Work))
    ...
    is_contributor_of.obj_class.add(ContentType.objects.get_for_model(model=F21_Recording_Work))
    ...
    is_voice_actor_of.obj_class.add(ContentType.objects.get_for_model(model=F21_Recording_Work))
    ...
    is_actor_of.obj_class.add(ContentType.objects.get_for_model(model=F21_Recording_Work))
    is_actor_of.save()
    ...
    is_broadcaster_of.subj_class.add(ContentType.objects.get_for_model(E40_Legal_Body))
    is_broadcaster_of.obj_class.add(ContentType.objects.get_for_model(F3_Manifestation_Product_Type))
    is_broadcaster_of.obj_class.add(ContentType.objects.get_for_model(F31_Performance))
    is_broadcaster_of.obj_class.add(ContentType.objects.get_for_model(F26_Recording))
    is_broadcaster_of.obj_class.add(ContentType.objects.get_for_model(Honour))
